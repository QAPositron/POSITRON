...
class CreateTemptrabajdosimentradarevsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temptrabajdosimentradarevs', function (Blueprint $table) {
            $table->bigincrements('id_temptrabajdosimentradarev')->unique();
    ...
    {
        Schema::dropIfExists('temptrabajdosimentradarevs');
    }
}
