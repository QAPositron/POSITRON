...
<div class="row">
    ...
    <div class="col-md text-center">
        <a type="button" class="btn btn-circle colorQA mt-5"  target="_blank" href="{{route('reporteNovedad.pdf', ['novedades'=> $novedad, 'contrato'=> $contdosisededepto->contratodosimetriasede->contratodosimetria_id])}}" >
