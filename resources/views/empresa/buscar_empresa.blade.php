...
<div class="row pt-3" id ="salida"> 
    ...
    <table class="table table-responsive hover table-bordered" id="empresas">
        <thead class="table-active align-middle">
            ...
            <th class="text-center">TIPO IDEN.</th>
            <th class="text-center" style='width: 9.60%'>N. IDEN.</th>
            <th class="text-center">CIUDAD</th>
            <th class="text-center">DIRECCIÓN</th>
            <th class="text-center" style='width: 16.60%'>EMAIL</th>
            <th class="text-center" style='width: 12.60%'>ACCIONES</th>
        </thead>
