        ...
        <form action="{{route('observacionesReventrada.save')}}" method="POST"  id="form-observacionesreventrada" name="form-observacionesreventrada" >
            ...
            <div class="row">
                <div class="col-md">
                    ...
                    @if($item == 1) 
                        <input type="number" name="novcontdosisededepto" value="{{$contdosisededepto->id_novcontdosisededepto}}" hidden>
                    @elseif($item == 0)
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        @endforeach
        @foreach($dosicontrolUnicoasig as $dosicontUniasig)
            if('{{$dosicontUniasig->revision_entrada}}' == 'TRUE'){
        ...
        console.log("item"+item);
            ...
            Swal.fire({
                ...
                $.ajax({
                    ...
                    type: "post",
                    url: "{{route('observaciones.remove')}}",
                    data:{
                        'id': id,
    ...
    function alertCertificado(empresa, id, mes, item){
        ...
        var obstrab = 0;
        var obsarea = 0;
        $.get('observacionesreventrada',{id : id, mes: mes, item: item})
        .done(function( obsrevent ){
            ...
            if(obsdosi == 0 && obstrab == 0 && obsarea == 0){
                $.get('asignacionesTrab',{id : id, mes: mes, item: item})
                .done(function(asignacionesTrab){
                    console.log("ASIGNACIONES TRAB");
                    ...
                    if(trab != 0){
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                var path = "http://"+host+"/POSITRON/public/reporteRevisionEntrada/"+empresa+"/"+id+"/"+mes+"/"+item+"/pdf";
                                window.open(path, '_blank');
                            }
                        })
                    
                    }else{
                        $.get('asignacionesCont', {id : id, mes: mes, item: item})
                        .done(function(asignacionesCont){
                            ...
                            if(dosi != 0){
                                ...
                                $.get('asignacionesArea', {id : id, mes: mes, item: item})
                                .done(function(asignacionesarea){
                                    ...
                                    if(area != 0){
                                        ...
                                        $.get('trabjencargado', {id : id, mes: mes, item: item}, function(trabjencargado){
