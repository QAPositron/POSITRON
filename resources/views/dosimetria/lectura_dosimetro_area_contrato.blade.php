            ...
            <div class="card-body">
                <div class="tab-content mt-3">
                    ...
                    <div class="tab-pane active" id="infoempresa" role="tabpanel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md m-4">
                                ...
                                <input type="text"  class="form-control text-center" name="deptoLectDosimControl" id="deptoLectDosimControl" value="{{$dosiareasig->contratodosimetriasededepto->departamentosede->nombre_departamento}}" readonly>
                                <br>
                            </div>
                            <div class="col-md m-4">
                    ...
                    <div class="tab-pane" id="lectura" role="tabpanel" aria-labelledby="lectura-tab">
                        {{-- <h4 class="card-title text-center pt-3">LECTURA DEL DOSÍMETRO TIPO {{$dosiareasig->dosimetro->tipo_dosimetro}} </h4> --}}
                        <h4 class="card-title text-center pt-5">CÓDIGO DEL DOSÍMETRO: {{$dosiareasig->dosimetro->codigo_dosimeter}}</h4>
                        <BR></BR>
                                    ...
                                    <form class="m-4" id="form_save_lectura_dosim" name="form_save_lectura_dosim" action="{{route('lecturadosiarea.save', $dosiareasig)}}" method="POST">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-4 mx-4">
                                                ...
                                                <div class="form-floating">
                                                    @if($dosiareasig->measurement_date != '')
                                                        <input type="date" class="form-control" name="measurement_date"  id="measurement_date" value="{{$dosiareasig->measurement_date}}" readonly>
                                                    @else
                                                        <input type="date" step="any" class="form-control" name="measurement_date"  id="measurement_date" value="{{$dosiareasig->measurement_date}}">
                                                    @endif
                                        ...
                                        {{-- <div class="row g-2">
                                            <div class="col-4 mx-4 ">
                                                <div class="form-floating">
                                                    @if($dosiareasig->measurement_date != '')
                                                        <input type="date" class="form-control" name="verification_Date" id="verification_Date" value="{{$dosiareasig->verification_date}}" readonly>
                                                    @else
                                                        <input type="date" class="form-control" name="verification_Date" id="verification_Date" value="{{$dosiareasig->verification_date}}">
                                                    @endif
                                            ...
                                            <div class="col mx-4 ">
                                                <div class="form-floating">
                                                    @if($dosiareasig->measurement_date != '')
                                                        <input type="date" class="form-control" name="verification_required_before" id="verification_required_before" value="{{$dosiareasig->verification_required_on_or_before}}" readonly>
                                                    @else
                                                        <input type="date" class="form-control" name="verification_required_before" id="verification_required_before" value="{{$dosiareasig->verification_required_on_or_before}}">
                                                    @endif
                                        ...
                                        <div class="row g-2">
                                             <div class="col-5 mx-4">
                                                <div class="form-floating">
                                                    @if($dosiareasig->measurement_date != '')
                                                        <input type="NUMBER" class="form-control" name="remaining_days_available_use" id="remaining_days_available_use" value="{{$dosiareasig->remaining_days_available_for_use}}" readonly>
                                                    @else
                                                    <input type="NUMBER" class="form-control" name="remaining_days_available_use" id="remaining_days_available_use" value="{{$dosiareasig->remaining_days_available_for_use}}">
                                                    @endif
    ...
    $(document).ready(function(){
        $('#extraviado').on('click', function(){
            ...
            if($.trim(extraviado_id) != 'false'){
                ...
                document.getElementById('h10_cal_dose').disabled = true;
                
            }else{
                
                document.getElementById('measurement_date').disabled = false;
                document.getElementById('h10_cal_dose').disabled = false;
