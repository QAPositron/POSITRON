...
<div class="row">
    ...
    <div class="col-md text-center">
        <a type="button" class="btn btn-circle colorQA mt-5"  @if($item == 0) href="{{route('repodosimetria.pdf', ['deptodosi' => $contdosisededepto->id_contdosisededepto, 'mesnumber' => $mesnumber, 'item'=> 0] )}}" @else href="{{route('repodosimetria.pdf', ['deptodosi' => $contdosisededepto->id_novcontdosisededepto, 'mesnumber' => $mesnumber, 'item'=> 1] )}}" @endif target="_blank">
