                        ...
                        <div class="tab-pane active" id="infotrabajador" role="tabpanel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md m-4">
                                    ...
                                    <input type="text"  class="form-control" name="telefonotrabLectDosim" id="telefonotrabLectDosim" value="{{$trabjasig->persona->telefono_persona}}" readonly>
                                </div>
                                <div class="col m-4">
                                    ...
                                    <input type="text"  class="form-control" name="generoLectDosim" id="generoLectDosim" value="{{$trabjasig->persona->genero_persona}}" readonly>
                                        ...
                                        <form class="m-4" id="form_edit_save_lectura_dosim" name="form_edit_save_lectura_dosim" action="{{route('lecturadosi.save', ['lecdosi'=>$trabjasig, 'item'=>$item])}}" method="POST">
                                           ...
                                           {{--  <div class="row g-2">
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-md d-grid gap-2">
                                                    <a class="btn btn-danger mt-2" type="button" id="cancelar" name="cancelar" href="{{route('asignadosicontrato.info', ['asigdosicont' => $trabjasig->contdosisededepto_id, 'mesnumber' => $trabjasig->mes_asignacion, 'item'=>$item])}}"  role="button">CANCELAR</a>
                                                </div>
                                                <div class="col-md"></div>
                                                <div class="col-md"></div>
                                            </div>
