...
<div class="row">
    ...
    <div class="col-md text-center">
        <a type="button" class="btn btn-circle colorQA mt-5" {{-- href="{{route('Reporterevisionsalida.pdf', ['empresa'=> 0, 'deptodosi' =>$contdosisededepto->id_contdosisededepto , 'mesnumber' => $mesnumber])}}" --}} onclick="alertCertificado('{{0}}', '{{$contdosisededepto->id_contdosisededepto}}', '{{$mesnumber}}', {{$dosicontrolasig}}, {{$trabjasignados}});" target="_blank">
