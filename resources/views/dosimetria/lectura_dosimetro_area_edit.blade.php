            ...
            <div class="card-body">
                <div class="tab-content mt-3">
                    ...
                    <div class="tab-pane active" id="lectura" role="tabpanel" aria-labelledby="lectura-tab">
                        ...
                        <h4 class="card-title text-center">{{$dosiareasig->areadepartamentosede->nombre_area}} <br> CÓDIGO DEL DOSÍMETRO: {{$dosiareasig->dosimetro->codigo_dosimeter}}</h4>
                        <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <div class="card text-dark bg-light">
                                    <form class="m-4" id="form_edit_save_lectura_dosim" name="form_edit_save_lectura_dosim" action="{{route('lecturadosiarea.save', ['lecdosicont'=>$dosiareasig, 'item'=>$item])}}" method="POST">
    ...
    $(document).ready(function(){
        ...
        if('{{$dosiareasig->contratodosimetriasede->dosimetriacontrato->periodo_recambio}}' == 'MENS'){
            ...
            for(var i=0; i<=(numLec+1); i= i+2){
                ...
                if("{{$dosiareasig->mes_asignacion}}" == x){
                    document.getElementById('mes{{$dosiareasig->mes_asignacion}}').innerHTML = fechaesp1+' - '+fechaesp2;
