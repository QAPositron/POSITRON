                ...
                <tr>
                    ...
                    <td class="align-middle text-center">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <form  name="eliminar_producto" action="{{route('productos.destroy', $prod->id_producto)}}" method="POST" class="mb-1 formeliminar_producto">
                                    @method('DELETE')
                                    @csrf  
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.formeliminar_producto').submit(function(e){
            e.preventDefault();
            Swal.fire({
