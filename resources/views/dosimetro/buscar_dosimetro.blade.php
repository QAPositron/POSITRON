                            ...
                            <div class="m-5">
                                <table class="table table-responsive table-hover table-bordered p-4 dosimetros">
                                    <thead class="table-active">
                                        <th class="align-middle text-center" scope='col' style='width: 18.60%'>CODIGO</th>
                                        <th class="align-middle text-center" scope='col'>TIPO</th>
                                        <th class="align-middle text-center" scope='col' style='width: 10.60%'>TECNOLOGIA</th>
                                        <th class="align-middle text-center" scope='col' style='width: 13.90%'>F. ING. AL SERV.</th>
                                        <th class="align-middle text-center" scope='col' style='width: 11.60%'>ESTADO</th>
                                        <th class="align-middle text-center" scope='col' style='width: 12.60%'>USO ACTUAL</th>
                                        <th class="align-middle text-center" scope='col' style='width: 15.90%'>ACCIONES</th>
                                    </thead>
                                    <tbody>
                                        {{-- ////////DOSIMETROS //////// --}}
                                ...
                                <div class="col-md-8">
                                    <div class="table-responsive">
                                        <table class="table table-hover table-bordered ">
                                            <thead class="table-active">
                                                <th class="align-middle text-center" scope='col'>CODIGO</th>
                                                <th class="align-middle text-center" scope='col'>TIPO</th>
                                                <th class="align-middle text-center" scope='col' >ESTADO</th>
