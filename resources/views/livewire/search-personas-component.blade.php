            ...
            @foreach($persona as $person)
                <tr>
                    ...
                    <td class="align-middle text-center">
                        @foreach($personasedes as $personsede)
                            @if($person->id_persona == $personsede->persona_id)
                                {{$personsede->nombre_empresa}} - {{$personsede->nombre_sede}} <br>
                            @endif
                        @endforeach
                    </td>
                    <td class="align-middle text-center">
                    ...
                    <td  class="align-middle text-center">
                        <div class="row">
                            <div class="col">
                                <a href="{{route('personas.edit', ['persona'=>$person->id_persona, 'trabestucont'=>0, 'empresa'=>0])}}" class="btn btn-secondary">
